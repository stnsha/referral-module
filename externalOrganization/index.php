...
<head>
    ...
    <link rel="stylesheet" media="screen" type="text/css" href="referral/externalOrganization/css/style.css?v=<?php echo filemtime(__DIR__ . '/css/style.css'); ?>" />
...
<body>
    <div class="header" style="position: relative;">
        ...
        <h1 class="headerH1"><img src='common/img/myreferral.png' width='20px'>External Organization</h1>
