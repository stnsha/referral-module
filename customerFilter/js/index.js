    ...
    function displayResults(data) {
        ...
        data.forEach(function (item) {
            ...
            const secondButton = item.is_external
                ? `<a href="#" class="btn-referral download-form-btn" data-id="${item.id}" data-ref-id="${item.ref_id}" data-timestamp="${item.ori_created_at}">Download Form</a>`
                : `<a href="referral/qr.php?id=${item.id}" class="btn-referral">Generate QR</a>`;
            ...
            rows += `
                <tr>
                    ...
                    <td style="font-size:14px;width: 30%;text-align:start;">${item.reason || ''}</td>
                    ...
                    <td style="font-size:14px;width: 25%;text-align:start;">
                        <a href="referral/view.php?id=${item.id}&view_only=true" class="btn-referral">View</a>
                        ${secondButton}
                    </td>
                </tr>
            `;
